export function getTransactionMined (web3, txnHash, options) {
  ...
  var transactionReceiptAsync = async function (txnHash, resolve, reject) {
    try {
      web3.eth.getTransactionReceipt (txnHash, async (err, receipt) => {
        if (!receipt) {
          setTimeout (function () {
  ...
  if (Array.isArray (txnHash)) {
    ...
    txnHash.forEach (function (oneTxHash) {
      promises.push (getTransactionMined (web3, oneTxHash, options));
    });
...
export default getTransactionMined;
